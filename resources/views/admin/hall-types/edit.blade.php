...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'admin.hall-types.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('admin.hall-types.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('admin.hall-types.update', [$hallType]) }}" method="POST">
...
@section('custom-js')
    @include('admin.hall-types.form-fields-js', ['from' => 'edit'])
@endsection
