...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'admin.subscriptions.create') }}
@endsection

@section('page-title', 'Create Subscriptions')
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('admin.subscriptions.create') }}
    </div>
@endsection
...
@section('custom-js')
    @include('admin.subscriptions.form-fields-js', ['from' => 'create'])
@endsection
