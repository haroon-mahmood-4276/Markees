...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.roles.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.roles.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.roles.update', [$role]) }}" method="POST"
...
@section('custom-js')
    @include('hall_owner.roles.form-fields-js', ['from' => 'edit'])
@endsection
