...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.roles.index') }}
@endsection

@section('page-title', __('lang.roles.role_plural'))

@section('page-vendor')
    {{ view('hall_owner.layout.libs.datatables.css') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.roles.index') }}
    </div>
@endsection
...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-1">
                            <div class="role-heading">
                                ...
                                <a href="{{ route('hall_owner.roles.edit', [$role]) }}" class="role-edit-modal"><span>Edit
                                        Role</span></a>
                            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('hall_owner.roles.destroy') }}" id="roles-table-form" method="get">
                        {{ $dataTable->table() }}
                    </form>
                </div>
            </div>
...
@section('vendor-js')
    {{ view('hall_owner.layout.libs.datatables.js') }}
@endsection
...
@section('custom-js')
    ...
    <script>
        ...
        function addNew() {
            location.href = "{{ route('hall_owner.roles.create') }}";
        }
    </script>
@endsection
