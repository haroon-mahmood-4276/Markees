...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.roles.create') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.roles.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.roles.store') }}" method="POST" enctype="multipart/form-data">

        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">

                @csrf
                @include('hall_owner.roles.form-fields')
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('hall_owner.roles.index') }}" class="btn btn-danger w-100 ">
...
@section('custom-js')
    @include('hall_owner.roles.form-fields-js', ['from' => 'create'])
@endsection
