...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.packages.create') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Package</h2>
        {{ Breadcrumbs::render('hall_owner.packages.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.packages.store') }}" method="POST" enctype="multipart/form-data">
...
@section('custom-js')
    @include('hall_owner.packages.form-fields-js', ['from' => 'create'])
@endsection
