...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.packages.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Edit Package</h2>
        {{ Breadcrumbs::render('hall_owner.packages.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.packages.update', [$package]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @csrf
                @method('PUT')
                @include('hall_owner.packages.form-fields')
                ...
                <div class="sticky-md-top top-lg-100px top-md-100px top-sm-0px" style="z-index: auto;">
                    <div class="card mb-4">
                        <div class="card-body">
                            {{-- <div class="row g-1">
                                <div class="col-md-12">
                                    <label class="form-label" style="font-size: 15px" for="attachment">Package
                                        Pictures</label>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('hall_owner.packages.index') }}" class="btn btn-danger w-100 ">
...
@section('custom-js')
    @include('hall_owner.packages.form-fields-js', ['from' => 'edit'])
@endsection
