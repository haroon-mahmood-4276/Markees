...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.cuisines.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.cuisines.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.cuisines.update', [$cuisine]) }}" method="POST"
                            ...
                            <div class="row g-3">
                                <div class="col-md-12">
                                    <button type="submit" class="btn btn-success w-100  buttonToBlockUI me-1">
                                        ...
                                        Update cuisines. </button>
                                </div>
                                <div class="col-md-12">
                                    <a href="{{ route('hall_owner.cuisines.index') }}" class="btn btn-danger w-100 ">
...
@section('custom-js')
    @include('hall_owner.cuisines.form-fields-js', ['from' => 'edit'])
@endsection
