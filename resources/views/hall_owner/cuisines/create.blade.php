...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.cuisines.create') }}
@endsection

@section('page-title', 'Create Cuisines')
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Cuisines</h2>
        {{ Breadcrumbs::render('hall_owner.cuisines.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.cuisines.store') }}" method="POST" enctype="multipart/form-data">

        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">

                @csrf
                @include('hall_owner.cuisines.form-fields')
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('hall_owner.decorations.index') }}" class="btn btn-danger w-100 ">
...
@section('custom-js')
    @include('hall_owner.cuisines.form-fields-js', ['from' => 'create'])
@endsection
