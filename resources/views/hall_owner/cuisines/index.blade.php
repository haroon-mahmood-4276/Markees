...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.cuisines.index') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.cuisines.index') }}
    </div>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('hall_owner.cuisines.destroy') }}" id="cuisines-table-form" method="get">
                        {{ $dataTable->table() }}
                    </form>
                </div>
            </div>
...
@section('custom-js')
    ...
    <script>
        ...
        function addNew() {
            location.href = "{{ route('hall_owner.cuisines.create') }}";
        }
    </script>
@endsection
