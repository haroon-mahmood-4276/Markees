...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.decorations.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.decorations.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.decorations.update', [$decoration]) }}" method="POST"
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @method('PUT')
                @csrf
                {{ view('hall_owner.decorations.form-fields', ['decoration' => $decoration]) }}
...
@section('custom-js')
    @include('hall_owner.decorations.form-fields-js', ['from' => 'edit'])
@endsection
