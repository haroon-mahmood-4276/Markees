...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.halls.slots.create', $hall->id) }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Halls Slots</h2>
        {{ Breadcrumbs::render('hall_owner.halls.slots.create', $hall->id) }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.halls.slots.store', [$hall]) }}" method="POST"
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @csrf
                @include('hall_owner.halls.settings.slots.form-fields')
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('hall_owner.halls.slots.index', [$hall]) }}"
...
@section('custom-js')
    @include('hall_owner.halls.settings.slots.form-fields-js', ['from' => 'create'])
@endsection
