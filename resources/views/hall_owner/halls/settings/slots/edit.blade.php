...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.halls.slots.edit', $hall->id) }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.halls.slots.edit', $hall->id) }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.halls.slots.update', [$hall, $slot]) }}" method="POST"
...
@section('custom-js')
    @include('hall_owner.halls.settings.slots.form-fields-js', ['from' => 'edit'])
@endsection
