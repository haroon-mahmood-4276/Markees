...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.permissions.index') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.permissions.index') }}
    </div>
@endsection
...
@section('custom-js')
    ...
    <script>
        function changeRolePermission(role_id, permission_id) {
            ...
            var url = "";
            if (checkBoxState) {
                url = "{{ route('hall_owner.permissions.assign-permission') }}";
            } else {
                url = "{{ route('hall_owner.permissions.revoke-permission') }}";
            }
