...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.menus.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Edit Menu</h2>
        {{ Breadcrumbs::render('hall_owner.menus.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.menus.update', [$menu]) }}" method="POST"
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @csrf
                @method('PUT')
                @include('hall_owner.menus.form-fields')
...
@section('custom-js')
    @include('hall_owner.menus.form-fields-js', ['from' => 'edit'])
@endsection
