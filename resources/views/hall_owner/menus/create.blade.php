...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.menus.create') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.menus.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.menus.store') }}" method="POST" enctype="multipart/form-data">
...
@section('custom-js')
    @include('hall_owner.menus.form-fields-js', ['from' => 'create'])
@endsection
