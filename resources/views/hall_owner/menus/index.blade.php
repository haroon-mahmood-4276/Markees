...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.menus.index') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Menus</h2>
        {{ Breadcrumbs::render('hall_owner.menus.index') }}
    </div>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('hall_owner.menus.destroy') }}" id="menus-table-form" method="get">
                        {{ $dataTable->table() }}
                    </form>
                </div>
            </div>
...
@section('custom-js')
    ...
    <script>
        ...
        function addNew() {
            location.href = "{{ route('hall_owner.menus.create') }}";
        }
    </script>
@endsection
