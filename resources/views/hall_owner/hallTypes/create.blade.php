...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'hall_owner.hallTypes.create') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('hall_owner.hallTypes.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('hall_owner.hallTypes.store') }}" method="POST"
...
@section('custom-js')
    @include('hall_owner.hallTypes.form-fields-js', ['from' => 'create'])
@endsection
