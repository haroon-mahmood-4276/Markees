...
@section('content')
    <form class="form form-vertical" action="{{ route('tenant.packages.store') }}" method="POST" enctype="multipart/form-data">
...
@section('custom-js')
    @include('tenant.app.packages.form-fields-js', ['from' => 'create'])
@endsection
