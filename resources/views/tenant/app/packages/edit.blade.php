...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.packages.edit', encryptParams($package->id)) }}
@endsection
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Edit Packages</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('tenant.packages.edit', encryptParams($package->id)) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <form class="form form-vertical" action="{{ route('tenant.packages.update', ['id' => encryptParams($package->id)]) }}"
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @method('PUT')
                @csrf
                {{ view('tenant.app.packages.form-fields', ['hallTypes' => $hallTypes, 'decorations' => $decorations, 'cuisines' => $cuisines, 'package' => $package]) }}
...
@php
    $images = $package->getMedia('packages');
@endphp
