...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.packages.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('tenant.packages.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('tenant.packages.update', [$package]) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @csrf
                @method('PUT')
                @include('tenant.app.packages.form-fields')
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('tenant.packages.index') }}" class="btn btn-danger w-100 ">
...
@section('custom-js')
    @include('tenant.app.packages.form-fields-js', ['from' => 'edit'])
@endsection
