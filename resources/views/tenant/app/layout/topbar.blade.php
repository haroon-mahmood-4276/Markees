            ...
            <li class="nav-item navbar-dropdown dropdown-user dropdown">
                <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                        <img src="{{ global_asset('theme-assets') }}/img/avatars/1.png" alt="" class="h-auto rounded-circle">
                    </div>
                </a>
                <ul class="dropdown-menu dropdown-menu-end pb-1">
                    <li>
                        <a class="dropdown-item" href="javascript:void(0);">
                            <div class="d-flex">
                                ...
                                <div class="flex-grow-1">
                                    <span class="fw-semibold d-block">{{ auth('tenant')->user()->name }}</span>
                                    {{-- <small
                                        class="text-muted">{{ implode(', ',auth('tenant')->user()->roles->pluck('name')->toArray()) }}</small> --}}
                                </div>
                            </div>
                        </a>
                    </li>
                    ...
                    <li>
                        <a class="dropdown-item btn-danger" href="{{ route('tenant.logout') }}">
