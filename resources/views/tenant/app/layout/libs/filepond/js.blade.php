...
{{-- <script src="{{ global_asset('theme-assets') }}/vendor/libs/cleavejs/cleave.min.js"></script>
    <script src="{{ global_asset('theme-assets') }}/vendor/libs/cleavejs/addons/cleave-phone.pk.min.js"></script> --}}
<script>
