...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.cuisines.edit', encryptParams($cuisine->id)) }}
@endsection

@section('page-title', 'Edit cuisines')
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Edit Cuisine</h2>
        {{ Breadcrumbs::render('tenant.cuisines.edit', encryptParams($cuisine->id)) }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('tenant.cuisines.update', ['id' => encryptParams($cuisine->id)]) }}"
        ...
        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @method('PUT')
                @csrf
                {{ view('tenant.app.cuisines.form-fields', ['cuisines' => $cuisine]) }}
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('tenant.cuisines.index') }}" class="btn btn-danger w-100 ">
    ...
    @php
        $images = $cuisine->getMedia('cuisines');
    @endphp
@endsection
