...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.cuisines.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('tenant.cuisines.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('tenant.cuisines.update', [$cuisine]) }}" method="POST"
...
@section('custom-js')
    @include('tenant.app.cuisines.form-fields-js', ['from' => 'edit'])
@endsection
