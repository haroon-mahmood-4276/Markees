...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.roles.index') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('tenant.roles.index') }}
    </div>
@endsection
...
@section('content')
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-end mt-1">
                            <div class="role-heading">
                                ...
                                <a href="{{ route('tenant.roles.edit', [$role]) }}" class="role-edit-modal"><span>Edit
                                        Role</span></a>
                            </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('tenant.roles.destroy') }}" id="roles-table-form" method="get">
                        {{ $dataTable->table() }}
                    </form>
                </div>
            </div>
...
@section('custom-js')
    ...
    <script>
        ...
        function addNew() {
            location.href = "{{ route('tenant.roles.create') }}";
        }
    </script>
@endsection
