...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.menus.edit', encryptParams($menu->id)) }}
@endsection

@section('page-title', 'Edit Menus')
...
@section('page-css')
    ...
    <link rel="stylesheet" type="text/css" href="{{ global_asset('theme-assets') }}/vendors/filepond/plugins/filepond.preview.min.css">
@endsection
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Edit Menus</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('tenant.menus.edit', encryptParams($menu->id)) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <form class="form form-vertical" action="{{ route('tenant.menus.update', ['id' => encryptParams($menu->id)]) }}" method="POST" enctype="multipart/form-data">

        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                @method('PUT')
                @csrf
                {{ view('tenant.app.menus.form-fields', ['menus' => $menus, 'cuisines' => $cuisines, 'menu' => $menu]) }}
