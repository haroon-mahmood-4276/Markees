...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.menus.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('tenant.menus.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('tenant.menus.update', [$menu]) }}" method="POST"
...
@section('custom-js')
    @include('tenant.app.menus.form-fields-js', ['from' => 'edit'])
@endsection
