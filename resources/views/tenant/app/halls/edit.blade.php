...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.halls.edit') }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('tenant.halls.edit') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('tenant.halls.update', [$hall]) }}" method="POST"
...
@section('custom-js')
    @include('tenant.app.halls.form-fields-js', ['from' => 'edit'])
@endsection
