<div class="card" style="border: 2px solid #7367F0; border-style: dashed; border-radius: 0;">
    <div class="card-body">
        ...
        <div class="row mb-1">
            <div class="col-lg-6 col-md-6 col-sm-12 position-relative">
                ...
                <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror"
                    ...
                    value="{{ isset($hall) ? $hall->name : old('name') }}" />
                @error('name')
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 position-relative">
                <label class="form-label fs-5" for="short_label">Short Label <span class="text-danger">**</span></label>
                <input type="text" class="form-control form-control-lg @error('short_label') is-invalid @enderror"
                    ...
                    value="{{ isset($hall) ? $hall->short_label : old('short_label') }}" onchange="convertToSlug(this);"
        ...
        <div class="row mb-1">
            <div class="col-lg-6 col-md-6 col-sm-12 position-relative">
                <label class="form-label fs-5" for="min_capacity">Minimum Capacity <span class="text-danger">*</span></label>
                <input type="number" class="form-control form-control-lg @error('min_capacity') is-invalid @enderror"
                    id="min_capacity" name="min_capacity" placeholder="Minimum Capacity"
            ...
            <div class="col-lg-6 col-md-6 col-sm-12 position-relative">
                <label class="form-label fs-5" for="max_capacity">Maximum Capacity <span class="text-danger">*</span></label>
                <input type="number" class="form-control form-control-lg @error('max_capacity') is-invalid @enderror"
                    id="max_capacity" name="max_capacity" placeholder="Maximum Capacity"
