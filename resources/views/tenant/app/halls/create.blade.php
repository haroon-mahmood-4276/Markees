...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        <h2 class="content-header-title float-start mb-0 mx-3">Create Hall</h2>
        {{ Breadcrumbs::render('tenant.halls.create') }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('tenant.halls.store') }}" method="POST" enctype="multipart/form-data">

        <div class="row g-3">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">

                @csrf
                @include('tenant.app.halls.form-fields')
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    <a href="{{ route('tenant.halls.index') }}" class="btn btn-danger w-100 ">
...
@section('custom-js')
    @include('tenant.app.halls.form-fields-js', ['from' => 'create'])
@endsection
