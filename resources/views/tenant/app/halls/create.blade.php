...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.halls.create') }}
@endsection

@section('page-title', 'Create Hall')
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Create Hall</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('tenant.halls.create') }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    <form class="form form-vertical" action="{{ route('tenant.halls.store') }}" method="POST"
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @csrf
                {{ view('tenant.app.halls.form-fields') }}

            </div>

            <div class="col-lg-3 col-md-3 col-sm-12 position-relative">
                <div class="sticky-md-top top-lg-100px top-md-100px top-sm-0px" style="z-index: auto;">
                    <div class="card" style="border: 2px dashed #7367F0; border-radius: 0;">
                        <div class="card-body">
                            <div class="row g-1">
                                <div class="col-md-12">
