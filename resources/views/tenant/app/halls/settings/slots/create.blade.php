...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'tenant.halls.slots.create', $hall->id) }}
@endsection
...
@section('breadcrumbs')
    <div class="d-flex justify-content-start align-items-center mb-3">
        ...
        {{ Breadcrumbs::render('tenant.halls.slots.create', $hall->id) }}
    </div>
@endsection

@section('content')
    <form class="form form-vertical" action="{{ route('tenant.halls.slots.store', [$hall]) }}" method="POST"
...
@section('custom-js')
    @include('tenant.app.halls.settings.slots.form-fields-js', ['from' => 'create'])
@endsection
