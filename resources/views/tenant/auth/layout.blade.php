...
<head>
    ...
    <link rel="stylesheet" href="{{ global_asset('theme-assets') }}/vendor/css/rtl/core.css"
    ...
    <link rel="stylesheet"
        href="{{ global_asset('theme-assets') }}/vendor/libs/formvalidation/dist/css/formValidation.min.css" />
...
<body>
    ...
    <!-- Vendors JS -->
    <script src="{{ global_asset('theme-assets') }}/vendor/libs/formvalidation/dist/js/FormValidation.min.js"></script>
    <script src="{{ global_asset('theme-assets') }}/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js"></script>
    <script src="{{ global_asset('theme-assets') }}/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js"></script>
