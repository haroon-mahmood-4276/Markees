...
@section('content')
    <div class="container-xxl">
        <div class="misc-wrapper">
            ...
            <div class="mt-4">
                <img src="{{ global_asset('theme-assets') }}/img/illustrations/page-misc-you-are-not-authorized.png"
                    alt="page-misc-not-authorized" width="170" class="img-fluid">
            </div>
        </div>
    </div>
    <div class="container-fluid misc-bg-wrapper">
        <img src="{{ global_asset('theme-assets') }}/img/illustrations/bg-shape-image-light.png" alt="page-misc-not-authorized"
